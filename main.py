...
def filtre_uygula(img, kernel, islem):
    ...
    bol_m = kernel_m // 2
    bol_n = kernel_n //2
    #burada kac piksel saga, kac piksel sola gidecek onu belirledik

    #np.pad(resim, ((ust, alt),(sol, sag)), ((usdeger,alt_deger),(sol_deger,sag_deger))
    ...
    out_img = np.zeros_like(padded_img) #0'larla dolu bos img
